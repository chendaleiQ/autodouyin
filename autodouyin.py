...
# 基本信息
# 视频存放路径
catalog_mp4 = r"./output"
# 视频描述
describe = "裸眼3D看蜘蛛侠 #搞笑 #电影 #视觉震撼"
# time.sleep(10)
options = webdriver.ChromeOptions()
options.add_argument("user-data-dir=/Users/chendalei/Library/Application Support/Google/Chrome/Default")
...
def publish_douyin():
    ...
    time.sleep(3)
    driver.find_element("xpath",'//*[text()="裁剪封面"]/..//*[text()="确定"]').click()
    time.sleep(3)
    driver.find_element("xpath",'//*[text()="设置封面"]/..//*[contains(@class,"upload")]//*[text()="确定"]').click()
    
    time.sleep(5)
    # 输入视频描述
    driver.find_element("xpath",'//div[@aria-autocomplete="list"]//br').send_keys(describe + " #上热门 #dou上热门 #我要上热门")
    
    # 设置选项
    time.sleep(1)
    driver.find_element("xpath",'//*[@class="radio--4Gpx6"]').click()
    time.sleep(1)
    driver.find_element("xpath",'//*[@class="semi-select-selection"]//span[contains(text(),"输入")]').click()
    time.sleep(1)
    driver.find_element("xpath",'//*[@class="semi-select-selection"]//input').send_keys("中关村人工智能科技")
    time.sleep(1)
    driver.find_element("xpath",'//*[@class="semi-select-selection"]//input').send_keys("园")
    time.sleep(5)
    driver.find_element("xpath",'//*[@class="semi-popover-content"]//*[text()="中关村人工智能科技园"]').click()
    ...
    time.sleep(1)
    driver.find_element("xpath",'//*[@class="DraftEditor-root"]//br').send_keys(describe + " #上热门")
    time.sleep(1)
